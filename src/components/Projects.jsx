...
function StatusPill({ status }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold ${map[status] || "bg-slate-100 text-slate-800"
        }`}
    >
...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen p-6 bg-white transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-BBH Sans Hegarty text-black">
            Projects
          </h1>
          ...
          <div className="flex-1">
            <label className="relative block">
              <input
                ...
                className="w-full pl-4 pr-10 py-2 rounded-lg border border-slate-200 bg-white text-black shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-200"
              />
          ...
          <div className="flex items-center gap-3">
            <div className="inline-flex overflow-hidden rounded-lg border border-slate-200">
              ...
              <button
                ...
                className={`px-3 py-1 text-sm ${filter === "completed"
                    ? "bg-white text-black"
                    : "text-black"
                  }`}
              >
